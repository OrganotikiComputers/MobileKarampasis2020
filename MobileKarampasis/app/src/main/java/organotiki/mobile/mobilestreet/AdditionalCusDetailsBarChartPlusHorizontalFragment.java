...
public class AdditionalCusDetailsBarChartPlusHorizontalFragment extends Fragment {
    private static final String ARG_POSITION = "position";
    private static final String ARG_TITLE = "title";
    BarChart barChart;
    AppCompatButton btnEmail;
    int chartColumnCount;
    ArrayList<CustomerDetailRow> chartDetails;
    int chartRowCount;
    int columnCount;
    ...
    public static AdditionalCusDetailsBarChartPlusHorizontalFragment newInstance(int position2, String Title) {
        AdditionalCusDetailsBarChartPlusHorizontalFragment f = new AdditionalCusDetailsBarChartPlusHorizontalFragment();
        Bundle b = new Bundle();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        try {
            super.onCreate(savedInstanceState);
            this.view = inflater.inflate(R.layout.fragment_additional_cus_details_bar_chart_horizontal_tab, (ViewGroup) null);
            ...
            this.btnEmail.setOnClickListener(new View.OnClickListener() {
                public void onClick(View v) {
                    ((AdditionalCustomerDetails) AdditionalCusDetailsBarChartPlusHorizontalFragment.this.getActivity()).setRequestingFragment(AdditionalCusDetailsBarChartPlusHorizontalFragment.this);
                    AdditionalCusDetailsBarChartPlusHorizontalFragment.this.request.getCustomerEmails(AdditionalCusDetailsBarChartPlusHorizontalFragment.this.getActivity(), ((AdditionalCustomerDetails) AdditionalCusDetailsBarChartPlusHorizontalFragment.this.getActivity()).getCustomer());
                }
            });
            this.tableLayout = (TableLayout) this.view.findViewById(R.id.tableLayout_customer_info_additional_customer_details);
            this.details.addAll(this.myTab.getHorizontalDetails());
            this.columnCount = this.details.get(0).getData().size();
            this.rowCount = this.details.size();
            setTableLayout();
            Log.d("asdfg", "columnCount:" + this.columnCount + ",rowCount:" + this.rowCount);
            this.chartDetails.addAll(this.myTab.getBarChartDetails());
            this.chartColumnCount = this.chartDetails.get(0).getData().size();
            this.chartRowCount = this.chartDetails.size();
            setBarChart();
            return this.view;
        } catch (Exception e) {
    ...
    private void setBarChart() {
        try {
            int i = this.chartRowCount;
            if (i == 2) {
                BarDataSet dataSet1 = new BarDataSet(DetailRowToBarEntryList(this.chartDetails.get(1).getData()), this.chartDetails.get(1).getData().get(0));
                ...
                final String[] Titles = DetailRowToStringArray(this.chartDetails.get(0).getData());
                ...
                List<BarEntry> entries = DetailRowToBarEntryList(this.chartDetails.get(1).getData());
                List<BarEntry> entries2 = DetailRowToBarEntryList(this.chartDetails.get(2).getData());
                BarDataSet dataSet12 = new BarDataSet(entries, this.chartDetails.get(1).getData().get(0));
                BarDataSet dataSet2 = new BarDataSet(entries2, this.chartDetails.get(2).getData().get(0));
                ...
                final String[] Titles2 = DetailRowToStringArray(this.chartDetails.get(0).getData());
                ...
                List<BarEntry> entries3 = DetailRowToBarEntryList(this.chartDetails.get(1).getData());
                List<BarEntry> entries22 = DetailRowToBarEntryList(this.chartDetails.get(2).getData());
                List<BarEntry> entries32 = DetailRowToBarEntryList(this.chartDetails.get(3).getData());
                BarDataSet dataSet13 = new BarDataSet(entries3, this.chartDetails.get(1).getData().get(0));
                BarDataSet dataSet22 = new BarDataSet(entries22, this.chartDetails.get(2).getData().get(0));
                BarDataSet dataSet3 = new BarDataSet(entries32, this.chartDetails.get(3).getData().get(0));
                ...
                final String[] Titles3 = DetailRowToStringArray(this.chartDetails.get(0).getData());
                ...
                List<BarEntry> entries4 = DetailRowToBarEntryList(this.chartDetails.get(1).getData());
                List<BarEntry> entries23 = DetailRowToBarEntryList(this.chartDetails.get(2).getData());
                List<BarEntry> entries33 = DetailRowToBarEntryList(this.chartDetails.get(3).getData());
                List<BarEntry> entries42 = DetailRowToBarEntryList(this.chartDetails.get(4).getData());
                BarDataSet dataSet14 = new BarDataSet(entries4, this.chartDetails.get(1).getData().get(0));
                BarDataSet dataSet23 = new BarDataSet(entries23, this.chartDetails.get(2).getData().get(0));
                BarDataSet dataSet32 = new BarDataSet(entries33, this.chartDetails.get(3).getData().get(0));
                BarDataSet dataSet4 = new BarDataSet(entries42, this.chartDetails.get(4).getData().get(0));
                ...
                dataSet32.setColors(getResources().getColor(R.color.colorF));
                ...
                final String[] Titles4 = DetailRowToStringArray(this.chartDetails.get(0).getData());
    ...
    private void doEmail() {
        try {
            ...
            this.positiveButton.setOnClickListener(new View.OnClickListener() {
                public void onClick(View v) {
                    try {
                        if (SystemClock.elapsedRealtime() - AdditionalCusDetailsBarChartPlusHorizontalFragment.this.mLastClickTime > 5000) {
                            long unused = AdditionalCusDetailsBarChartPlusHorizontalFragment.this.mLastClickTime = SystemClock.elapsedRealtime();
                            if (!AdditionalCusDetailsBarChartPlusHorizontalFragment.this.isEmailValid(input1.getText())) {
                                if (!AdditionalCusDetailsBarChartPlusHorizontalFragment.this.isEmailValid(input2.getText())) {
                                    Toast.makeText(AdditionalCusDetailsBarChartPlusHorizontalFragment.this.getActivity(), "Πρέπει να συμπληρώσετε με τουλάχιστον μια σωστή διεύθυνση email.", Toast.LENGTH_LONG).show();
                                    return;
                                }
                            }
                            Toast.makeText(AdditionalCusDetailsBarChartPlusHorizontalFragment.this.getActivity(), "Παρακαλώ περιμένετε.", Toast.LENGTH_LONG).show();
                            AdditionalCusDetailsBarChartPlusHorizontalFragment.this.request.SentEmailWithImage(AdditionalCusDetailsBarChartPlusHorizontalFragment.this.getActivity(), AdditionalCusDetailsBarChartPlusHorizontalFragment.this.barChart.getChartBitmap(), AdditionalCusDetailsBarChartPlusHorizontalFragment.this.details, AdditionalCusDetailsBarChartPlusHorizontalFragment.this.title, String.valueOf(input1.getText()), String.valueOf(input2.getText()));
                            AdditionalCusDetailsBarChartPlusHorizontalFragment.this.positiveButton.setEnabled(false);
                        }
                    } catch (Exception e) {
                        Log.e("asdfg", e.getMessage(), e);
                    }
