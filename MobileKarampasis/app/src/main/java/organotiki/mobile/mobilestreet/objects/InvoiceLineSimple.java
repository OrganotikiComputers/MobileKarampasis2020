...
/**
 * Created by Thanasis on 2/6/2016.
 */
public class InvoiceLineSimple {
    ...
    public InvoiceLineSimple(String ID, Invoice invoice, Item item, Double price, Double quantity, Double discount, Double value, String notes) {
        this.ID = ID;
        myInvoice = invoice;
        myItem = item;
        Price = price;
